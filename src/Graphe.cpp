...
Graphe::Graphe(std::string nomFichier)
{
    ...
    {
        ifs >> id3 >> id1 >> id2;
        ///Deux condition pour les adjacents si le graphe est orienté (=1) ou non (=0).
        if(orientation==1)
        {
...
void Graphe::centraliteDegre()
{
    ...
    ///Affichage console, modification couleur sommet, et sauvegarde fichier texte
    for(unsigned i=0; i<m_ListeSommets.size(); ++i)
    {
...
void Graphe::Vulnerabilite()
{
    ...
    std::cin>>nbrArete;
    ///Si le graphe est non orienté et que le nombre d'arete est non nul
    ...
    ///Si le graphe est orienté et le nombre d'arete non nul
